...
# ---------- 5) สร้างโมเดล KNN แบบ Multi-Output ----------
...
# ---------- 8) บันทึกโมเดล ----------
joblib.dump(multi_model, "knn_multi_model.pkl")
joblib.dump(le_stress, "knn_multi_label_encoder_stress.pkl")
joblib.dump(le_activity, "knn_multi_label_encoder_activity.pkl")
